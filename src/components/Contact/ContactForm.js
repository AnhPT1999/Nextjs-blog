...
export default function ContactForm() {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='mt-12 text-base xs:text-lg sm:text-xl font-medium leading-relaxed font-in'>
            ...
            />
            and I want to discuss a potential project. You can email me at<input type="text" placeholder="your@email" {...register("email", { required: true })} 
                className='outline-none border-0 p-0 mx-2 focus:ring-0 placeholder:text-center placeholder:text-lg border-b border-gray
                focus:border-gray bg-transparent'
            />
            or reach out to me on<input type="tel" placeholder="your phone" {...register} 
                className='outline-none border-0 p-0 mx-2 focus:ring-0 placeholder:text-center placeholder:text-lg border-b border-gray
                focus:border-gray bg-transparent'
            />
            ...
            <input type="submit" value="Send" className='mt-8 font-medium inline-block capitalize text-base xs:text-lg sm:text-xl py-2 sm:py-3 px-6 sm:px-6 border-2 border-solid border-dark dark:border-light rounded cursor-pointer' />
        </form>
    );
}